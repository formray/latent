...
1. **R4 spec (current):** `/Users/giuseppealbriziowork/fuji-comp/docs/superpowers/specs/2026-05-03-fujicomp-v1-design.md` (995 lines, 18 sections, includes §17 R2→R3 changelog + §18 R3→R4 changelog + convergence statement)
2. **R3 review output (your prior R3 output):** `/Users/giuseppealbriziowork/fuji-comp/docs/superpowers/codex-review-output-r3.md`
