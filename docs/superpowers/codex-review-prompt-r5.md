...
1. **R5 spec (current):** `the repo root/docs/superpowers/specs/2026-05-03-fujicomp-v1-design.md` (1182 lines, 19 sections — added §6.7, §6.8, renumbered §6.7 typed errors → §6.9, added §19 changelog)
