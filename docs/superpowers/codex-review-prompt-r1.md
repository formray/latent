...
**Author's organization (Formray) has its own engineering guidelines** at `Formray engineering guidelines (private reference at the time)` (17 modules, 00-16). Most relevant: `12-technology-stacks.md`, `13-macos-distribution.md`, `15-hardware-firmware.md`, `16-ai-native-patterns.md`. Formray root context: `Formray root context (private reference at the time)` and `Formray foundation context (private reference at the time)`. The spec MUST align with these guidelines unless deviation is justified.

# Your task

Read this file end-to-end:
**`the repo root/docs/superpowers/specs/2026-05-03-fujicomp-v1-design.md`** (510 lines, 16 sections)
