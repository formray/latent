...
1. **R3 spec (current):** `/Users/giuseppealbriziowork/Repos/Formray/filmfork/docs/superpowers/specs/2026-05-03-fujicomp-v1-design.md` (964 lines, 17 sections, includes §17 changelog R2→R3)
2. **R2 review output (your prior R2 output):** `/Users/giuseppealbriziowork/Repos/Formray/filmfork/docs/superpowers/codex-review-output-r2.md`
3. **R2 review prompt (for context):** `/Users/giuseppealbriziowork/Repos/Formray/filmfork/docs/superpowers/codex-review-prompt-r2.md`
4. **R1 artifacts (for full lineage):** `codex-review-prompt-r1.md` + `codex-review-output-r1.md` in same folder
5. **Formray engineering guidelines:** `/Users/giuseppealbriziowork/Repos/Formray/formray-foundation/engineering-guidelines/` (12, 13, 15, 16 most relevant)
