...
export function MacosSetupWizard({
  ...
  if (acknowledged) {
    return (
      <div role="dialog" aria-modal="true" className="max-w-sm rounded-sm border border-emerald-500/40 bg-zinc-950/95 p-3 text-sm text-emerald-100 shadow-xl shadow-black/30">
